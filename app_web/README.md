# [Django SB Admin](https://appseed.us/admin-dashboards/django-dashboard-sb-admin)

Admin dashboard generated by AppSeed in **Django** Framework. **[SB Admin](https://appseed.us/admin-dashboards/django-dashboard-sb-admin)** is a free, open source, Bootstrap 4 based admin theme perfect for quickly creating dashboards and web applications. It's modern design style with subtle shadows and a card-based layout could be described as flat material, and is inspired by the principles of material design along with a simple, attractive color system. - Design provided by.
...
- [Django SB Admin](https://docs.appseed.us/products/django-dashboards/sb-admin) - product documentation
...
![Boierplate Code Django Dashboard - Template project provided by AppSeed.](https://raw.githubusercontent.com/app-generator/django-dashboard-sb-admin/master/media/django-dashboard-sb-admin-screen.png)
...
```bash
$ # Get the code
$ git clone https://github.com/app-generator/django-dashboard-sb-admin.git
$ cd django-dashboard-sb-admin
$
...
---
[Django SB Admin](https://appseed.us/admin-dashboards/django-dashboard-sb-admin) - Provided by **AppSeed [App Generator](https://appseed.us/app-generator)**.
